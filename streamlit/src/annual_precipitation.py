...
def run_annual_precipitation():
    ...
    st.markdown("---")                                    
    london_yearly_mean, london_yearly_points = load_data('./data/data_london_yearly_mean.parquet', 
                                                         './data/data_london_yearly_sum_all_points.parquet')
    puglia_yearly_mean, puglia_yearly_points = load_data('./data/data_puglia_yearly_mean.parquet', 
                                                         './data/data_puglia_yearly_sum_all_points.parquet')
